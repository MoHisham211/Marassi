...
data class Profile(
    ...
    val can_process_multiple_refunds: Boolean,
    ...
    val ignore_flash_callbacks: Boolean,
    val instant_settlement_enabled: Boolean,
    val instant_settlement_transaction_otp_verified: Boolean,
    val is_2fa_enabled: Boolean,
    val is_bills_new: Boolean,
    val is_eligible_to_be_ranger: Boolean,
    val is_mobadra: Boolean,
    val is_poaching: Boolean,
    val is_ranger: Boolean,
    ...
    val otp_2fa_attempt: Any,
    val otp_2fa_sent_at: Any,
    val otp_sent_at: String,
    val otp_sent_to: String,
    val otp_validated_at: String,
    ...
    val settlement_classification: Int,
